(function() {
    ...
    PessoaDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Pessoa', 'Usuario'];

    function PessoaDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Pessoa, Usuario) {
        var vm = this;
        ...
        function onSaveSuccess (result) {
            $scope.$emit('tccmanagerApp:pessoaUpdate', result);
