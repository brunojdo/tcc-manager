...
public class UserService {
	...
	public User createUser(String login, String password, String firstName, String lastName, String email,
			String imageUrl, String langKey, Set<String> authoritiesConstants) {
		...
		//Adicionar os nivel de autoridade
		for (String string : authoritiesConstants) {
			Authority authority = authorityRepository.findOne(string);
